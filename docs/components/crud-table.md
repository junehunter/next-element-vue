...
| page                | 表格分页参数                                                                        | `object`                             | object                               | `{ pageNo: 1, pageSize: 10, total: 0, }` |
...
| click-add-edit    | 点击新增或编辑按钮时触发的事件                                                                                           | row, [options](./crud-table#options-配置) |
| view-add-edit     | 点击查看按钮时触发的事件                                                                                                 | row                                       |
| close-add-edit    | 点击关闭新增或编辑按钮时触发的事件                                                                                       | -                                         |
| delete-rows       | 批量删除选中行数据                                                                                                       | rows, done()                              |
| delete-row        | 点击删除按钮时触发的事件                                                                                                 | row, done()                               |
| submit-form       | 点击提交新增或编辑按钮时触发的事件                                                                                       | params, done(), error()                   |
...
| operationsHeaderAlign         | table操作栏默认对齐方式                               | string   | left / center / right                                    | center    |
| operationsColumnAlign         | column默认对齐方式                                    | string   | left / center / right                                    | center    |
...
| showSearchLabel               | 是否显示table搜索栏label                              | boolen   | -                                                        | false     |
...
| dialogCloseOnClickModal       | 新增/编辑/详情 是否可以通过点击 modal 关闭窗口        | boolen   | -                                                        | false     |
...
| formSpanFixed                 | 新增/编辑/详情 表单列固定span                         | number   | -                                                        | null      |
| formColumns                   | 新增/编辑/详情 表单列比例span                         | array    | [FormColunmProps](./crud-table#FormColunmProps-配置)     | -         |
| loadFormDetail                | 新增/编辑/详情 表单加载详情方法                       | function | -                                                        | null      |
...
| cellUnit            | 单元格单位                       | string         | -                                                                                                                                                                                      | -        |
| renderColumnCell    | 自定义渲染单元格内容             | function       | function({row, column, index})                                                                                                                                                         | -        |
...
| type                | 搜索栏或表单类型列显示           | string         | `input` `inputInteger` `inputNumber` `textarea` `select` `radio` `checkbox` `date` `timeSelect` `datetime` `datetimerange` `numberRange` `inputTableSelect` `uploadImage` `timePicker` | input    |
...
| 插槽名                  | 说明                             | 子标签 |
| ----------------------- | -------------------------------- | ------ |
| menu-left-prefix        | 自定义表格菜单左侧前缀内容       | -      |
| menu-left-suffix        | 自定义表格菜单左侧后缀内容       | -      |
| menu-left-suffix        | 自定义表格菜单左侧后缀内容       | -      |
| operation-column-prefix | 自定义表格操作列左侧前缀内容     | -      |
| operation-column-suffix | 自定义表格操作列左侧后缀内容     | -      |
| column-[column.prop]    | 自定义表格列内容，根据列属性     | -      |
| search-[column.prop]    | 自定义表格搜索栏内容，根据列属性 | -      |
| form-[column.prop]      | 自定义表格表单栏内容，根据列属性 | -      |
