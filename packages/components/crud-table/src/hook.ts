...
export const updateFormColumns = (options: any, cb: Function) => {
	...
	const mergeFormColumns = evenTableColumns.concat(formColumns).map((col: FormColunmProps & FormItemProps) => {
		const item: FormItemProps = {
			...
			editDisabled: valueExist(col.formEditDisabled, col.editDisabled, false),
			textareaAutosize: valueExist(col.formTextareaAutosize, false),
			textareaRows: valueExist(col.formTextareaRows, 2),
			inputMinlength: valueExist(col.formInputMinlength, null),
			inputMaxlength: valueExist(col.formInputMaxlength, null),
			...
			format: valueExist(col.formFormat, col.format, null),
			startPlaceholder: valueExist(col.formStartPlaceholder, col.startPlaceholder, null),
			endPlaceholder: valueExist(col.formEndPlaceholder, col.endPlaceholder, null),
			rangeSeparator: valueExist(col.formRangeSeparator, col.rangeSeparator, null),
			timePickerProps: valueExist(col.formTimePickerProps, col.timePickerProps, null),
			timeSelectProps: valueExist(col.formTimeSelectProps, col.timeSelectProps, null),
			tip: valueExist(col.formTip, col.tip, null),
			renderDividerBefore: valueExist(col.formRenderDividerBefore, col.renderDividerBefore, null),
			renderDividerAfter: valueExist(col.formRenderDividerAfter, col.renderDividerAfter, null),
			...
			collapseTags: valueExist(col.formCollapseTags, col.collapseTags),
			collapseTagsTooltip: valueExist(col.formCollapseTagsTooltip, col.collapseTagsTooltip, true),
			limit: valueExist(col.formLimit, col.limit, 1),
			accept: valueExist(col.formAccept, col.accept, null),
			...
			onClear: valueExist(col.onClearForm, col.onClear, null),
			onBlur: valueExist(col.onBlurForm, col.onBlur, null),
			onFocus: valueExist(col.onFocusForm, col.onFocus, null),
			onExceed: valueExist(col.onExceedForm, col.onExceed, null),
			...
			filterable: valueExist(col.formFilterable, col.filterable, false),
			showAllLevels: valueExist(col.formShowAllLevels, col.showAllLevels, true),
			allowCreate: valueExist(col.formAllowCreate, col.allowCreate, false),
			...
			checkOnClickNode: valueExist(col.formCheckOnClickNode, col.checkOnClickNode, false),
	...
	const _formatSearchColumn = (col: SearchColumnProps & FormItemProps, index: number) => {
		const item: SearchColumnProps & FormItemProps = {
			...
			searchDisabledDate: valueExist(col.searchDisabledDate, null),
			...
			rangeSeparator: valueExist(col.searchRangeSeparator, col.rangeSeparator, null),
			startPlaceholder: valueExist(col.searchStartPlaceholder, col.startPlaceholder, null),
			endPlaceholder: valueExist(col.searchEndPlaceholder, col.endPlaceholder, null),
			...
			showSearchLabel: valueExist(col.showSearchLabel, true),
			...
			checkOnClickNode: valueExist(col.searchCheckOnClickNode, col.checkOnClickNode, false),
